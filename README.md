...
## Что осталось внешним сервисам

Для учебной локальной проверки Stripe, Pusher и Web Push сделаны как демонстрационные сценарии без внешних ключей. Для промышленного режима нужно подключить реальные ключи Stripe, Pusher и VAPID.
